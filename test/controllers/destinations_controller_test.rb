...
class DestinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post destinations_url, params: { destination: { description: @destination.description, title: @destination.title } }
    end
  ...
  test "should update destination" do
    patch destination_url(@destination), params: { destination: { description: @destination.description, title: @destination.title } }
